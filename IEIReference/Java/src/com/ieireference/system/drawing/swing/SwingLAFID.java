...
public final class SwingLAFID {
	...
	/**
	 * You can apply LAF here. Apply and update component.
	 * 
	 * @param laf Use the IDs of class.
	 * @param c the component to update Look And Feel.
	 * 
     * @exception ClassNotFoundException if the <code>LookAndFeel</code>
     *           class could not be found
     * @exception InstantiationException if a new instance of the class
     ...
     *         a class that extends {@code LookAndFeel}
     */
	public static void applyLAF(String laf, Component c) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
		UIManager.setLookAndFeel(laf);
